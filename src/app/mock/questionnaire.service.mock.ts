...
export class QuestionnaireServiceMock {
    ...
    toFormGroup(questions: any) {
        const group = this.fb.group({
            1: new FormControl('', [Validators.required, this.booleanValidator()]),
            2: new FormGroup({
                2.1: new FormControl('', [Validators.required, this.genderValidator()]),
                2.2: new FormControl('', [Validators.required, Validators.pattern('\\d{4}-\\d{2}-\\d{2}')]),
                2.3: new FormControl('', [Validators.required, this.countryValidator()]),
                2.4: new FormControl('', [Validators.required, this.marritalValidator()]),
            }),
            3: new FormGroup({
                3.1: new FormControl('', [Validators.required, this.booleanValidator()]),
                3.2: new FormControl('', [Validators.required, this.booleanValidator()]),
            })
        });
